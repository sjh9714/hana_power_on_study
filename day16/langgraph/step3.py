...
router_node()의 리턴값 명이 다른 경우 예제 

builder.add_conditional_edges(
    "router",
    route_function,
    {
        "time_router_key": "time",
        "calculator_router_key": "calculator",
        "chat_router_key": "chat"
    }
)
...
def router_node(state: AgentState):
    ...
    if "시간" in question:
        ...
        route = "time_router_key"

    # 계산 관련 질문
    elif "+" in question or "*" in question:

        route = "calculator_router_key"

    # 그 외 일반 질문
    else:

        route = "chat_router_key"
